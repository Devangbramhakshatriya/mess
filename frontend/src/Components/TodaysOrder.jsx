...
function TodaysOrder() {
    ...
    const handleDelete = (e) => {
        ...
        if (time > time1) {
            ...
            fetch(`http://localhost:4500/orders/${e._id}`, {
                method: 'DELETE',
                headers: {
    ...
    return (
        <Box>{isLoading ? <Image src="https://cdn.dribbble.com/users/645440/screenshots/3266490/loader-2_food.gif" m="auto" />
            ...
            or.length > 0 ? <Box><Text>Don't Worray Your Food Will Diliver On Time</Text>
                <Image src="https://cdn.dribbble.com/users/2243442/screenshots/11362056/cooking-at-home.gif" w="30%" m="auto" />
                {
                    or.map((e) => (
                ...
                :
                <Box>
                    <Text>You Not Ordered Anythink For Today!</Text>
